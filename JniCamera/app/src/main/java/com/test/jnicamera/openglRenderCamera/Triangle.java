...
//        mProgram = GLES20.glCreateProgram();
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        mPositionHandle = GLES20.glGetAttribLocation(mProgram, "vPosition2");
        //启用三角形顶点的句柄
        ...
        //获取片元着色器的vColor成员的句柄
        mColorHandle = GLES20.glGetUniformLocation(mProgram, "vColor2");
        //设置绘制三角形的颜色
    ...
    public void setProgrem(int progrem) {
        this.mProgram = progrem;
    }
