...
public class Camera2RawFragment extends Fragment implements FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    /**
     * 没有 任何 数据 处理 和转换 只是 在 改变camera 的状态的时候提供一把锁
     */
...
//                        imageView.setImageBitmap(bitmap);
    ...
    private boolean setUpCameraOutputs() {
        ...
        if (manager == null) {
            SystemDialog.getInstance().showPositiveDialog(getActivity(), "This device doesn't support Camera2 API.", new DialogResultCallBack() {
                @Override
        ...
        SystemDialog.getInstance().showPositiveDialog(getActivity(), "This device doesn't support capturing RAW photos",
                            ...
                            synchronized (mCameraStateLock) {
                                ...
                                try {
                                    ...
                                    cameraCaptureSession.setRepeatingRequest(
                                            mPreviewRequestBuilder.build(), mPreCaptureCallback, mBackgroundHandler);
    ...
    private void configureTransform(int viewWidth, int viewHeight) {
        ...
        synchronized (mCameraStateLock) {
            ...
            // getOutputSizes 获取与请求的图像format兼容的大小列表
